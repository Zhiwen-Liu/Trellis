...
| [Trellis Core SDK](./trellis-core-sdk.md) | `@zhiwenliu/trellis-core` / CLI package boundary, public exports, build and versioning contracts | Done |
...
- Editing `packages/core/**`, moving reusable CLI logic into core, or changing CLI imports from `@zhiwenliu/trellis-core` → [trellis-core-sdk.md](./trellis-core-sdk.md)
