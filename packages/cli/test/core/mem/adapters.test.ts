 ...
 * the core mem module (`src/core/mem/`).
 */
...
const { claudeListSessions, claudeExtractDialogue, claudeSearch } =
  await import("../../../src/core/mem/adapters/claude.js");
const { claudeProjectDirFromCwd } =
  await import("../../../src/core/mem/internal/paths.js");
...
} = await import("../../../src/core/mem/adapters/grok.js");
const {
...
} = await import("../../../src/core/mem/adapters/opencode.js");
const { opencodeDataDir, opencodeDbPath, HOME } =
  await import("../../../src/core/mem/internal/paths.js");
const { piListSessions, piExtractDialogue, piSearch } =
  await import("../../../src/core/mem/adapters/pi.js");
const {
  zcodeListSessions,
  zcodeExtractDialogue,
  zcodeSearch,
  collectZcodeTurnsAndEvents,
} = await import("../../../src/core/mem/adapters/zcode.js");
const { ZCODE_DB } = await import("../../../src/core/mem/internal/paths.js");

import type { MemFilter, MemSessionInfo } from "../../../src/core/mem/types.js";
import {
  findPythonForSqlite,
  runPythonScript,
